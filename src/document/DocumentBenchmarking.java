				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 for(int i=0;i<trials;i++){
				 BasicDocument bd1 = new BasicDocument(getStringFromFile(textfile, numToCheck));
				 bd1.getFleschScore();
				 }
			 ...
			 startTime = System.nanoTime();
			 for(int i=0;i<trials;i++){
				 EfficientDocument ed1 = new EfficientDocument(getStringFromFile(textfile, numToCheck));
				 ed1.getFleschScore();
			 }
			 endTime = System.nanoTime();
			 System.out.print((endTime-startTime)/1000000000.0 + "\n");
